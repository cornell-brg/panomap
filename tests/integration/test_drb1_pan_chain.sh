#!/bin/bash
# Integration test: DRB1 pangenome mapping accuracy with pan-chain backend
# Same setup as test_drb1_accuracy.sh but uses --chainer pan-chain
#
...
echo ""
echo "Result: recall=$RECALL% mapping_accuracy=$MAP_ACC% ($CORRECT/$TOTAL correct, $WRONG wrong) [drb1 pan-chain]"
