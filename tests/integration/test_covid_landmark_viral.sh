#!/bin/bash
# Integration test: COVID linear reference with landmark tokenizer
# Best landmark config: k=4, viral chaining, no-adaptive, diff=0.2, no-anchor-merge
...
echo ""
echo "Result: recall=$RECALL% mapping_accuracy=$MAP_ACC% ($CORRECT/$TOTAL correct, $WRONG wrong) [covid r9.4 landmark-k4]"
